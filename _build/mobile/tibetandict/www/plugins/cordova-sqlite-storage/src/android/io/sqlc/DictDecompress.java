...
public class DictDecompress {
    static final String ZLIB_DICT = " perfections pupil ru. skom Sumeru summary treat tshi vidyadhara voidness (1998) adorned battle bright, "+
    ...
    public static String inflateText(byte[] rawDeflateData)  {
        ...
        try{
            ...
            inflater.setDictionary(ZLIB_DICT.getBytes("UTF-8"));
