...
import { setInputLang, setSidebarVisible, setSearchMode, type SearchMode } from '@/store/searchSlice';
import styles from './TopBar.module.css';
import type { RootState } from '@/store/store';
import { Language } from '@/types';
import { useDictNavigation } from '@/hooks/useDictNavigation';
import { ExtendedSearchMode } from '@/store/extendedSearchSlice';
...
export default function TopBar(props: Props) {
  ...
  useEffect(() => { // clear input field when language changes
        ...
        <div style={{ display: 'flex', alignItems: 'center', width: '100%' }}>
          ...
          <span className="mr-3" title="Open menu">
            <HamburgerMenu
              ...
              onSelectLanguage={props.onLangChange}
              onOpenExtendedSearch={props.onOpenExtendedSearch}
